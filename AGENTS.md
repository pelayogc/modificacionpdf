...
- En apps protegidas con Cloudflare Access, no usar `same_site_cookie_attribute=strict` salvo que se haya probado el login real. Puede provocar bucles de redireccion tras volver del IdP. Preferir `lax` para apps web normales.
